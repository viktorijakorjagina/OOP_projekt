...
public class Eksam {
    ...
    private static final int läbimisePiir = 50; // läbimiseks vajalik punktide arv
    ...
    public void sooritaEksam(Õpilane õpilane) {
        ...
        JOptionPane.showMessageDialog(null,
                "Eksami tulemuste arvutamine...\n\n" +
                        ...
                        "(Läbimiseks vajad: " + läbimisePiir + " pumkti)",
                "Tulemused",
                JOptionPane.INFORMATION_MESSAGE);

        // Näita lõpptulemust
        if (lõplikSkoor >= läbimisePiir) {
            JOptionPane.showMessageDialog(null,
    ...
    private String getLäbikukkumiseSünum(int teadmised, int õnn) {
        ...
        else if (teadmised >= läbimisePiir) {
